...
public class Driver
{
  ...
  public static void main(String[] args) 
  {
    ...
    walker = front;
  	...
  	System.out.println(walker.getData());
    System.out.println("Here is the data list!");
    //prints only data in the node
    while(walker != null){
      System.out.println("Node " + walker +"'s data is " + walker.getData());
      walker = walker.getNext();
    }
    walker = front;
    while(walker != null){
    ...
    //simplified version from Jihae's demo prints full node
    walker = front;
    System.out.println("Here is Node list!");
    while(walker != null)
    {
